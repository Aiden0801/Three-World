...
export function PwaInstallButton(props: ButtonProps) {
  const [handlePwaInstall, installed, available] = usePwaInstall()

  if (installed) return null

  return (
    <Button {...props} disabled={!available} onClick={handlePwaInstall}>Install App</Button>
  )
}

// TODO: Move all the hooks in src/hooks to allow for more UI options (i.e. button, banner, ...)
