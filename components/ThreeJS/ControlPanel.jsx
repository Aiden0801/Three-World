...
import { IconDownload, IconWorldDownload, IconArrowBigLeft, IconArrowBigRight, IconActivity } from '@tabler/icons';
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {curBrowser && curBrowser.data.url == 'none' && <IconActivity color='red' size={15} />}
                    {curBrowser && curBrowser.data.url != 'none' && <IconActivity color='green' size={15} />}
                </Text>
                <Text
                    align="center"
                    variant="gradient"
                ...
                <Button size="md" leftIcon={<IconWorldDownload size={20} />}
